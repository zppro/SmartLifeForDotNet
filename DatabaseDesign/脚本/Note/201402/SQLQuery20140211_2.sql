...
update dbo.Oca_OldManBaseInfo set Tel='15'+right(latitudes,9) where Tel is null
...
update dbo.Oca_OldManBaseInfo set LivingState='00001' where LivingState is null and ID<18;
