...
object_id,name,column_id,seed_value,increment_value
 ...
 select user_name() schema_name,a.name tablename,b.name columnname
 from [Smartlife-120300].sys.tables  a,[Smartlife-120300].sys.identity_columns b
...
drop table Sys_DictionaryItemExtend;
drop table Cer_Redirect;
drop table Sys_Menu;
drop table Inc_SyncIn_Resident;
drop table Sys_MenuBehavior;
drop table Log_SystemJob;
drop table Sys_Parameter;
drop table oca_call_service_stat_report;
drop table Sys_Platform;
drop table Oca_CallCenter;
drop table Sys_PlatformApplication;
drop table Oca_CallRecord;
drop table Sys_Server;
drop table Oca_CallService;
drop table Sys_Tree;
drop table Oca_CC_Ext;
drop table Sys_TreeItem;
drop table Oca_CC_Group;
drop table Sys_WhiteList;
drop table Oca_CC_SeatExtBind;
drop table sysdiagrams;
drop table Oca_CC_SeatExtBindHistory;
drop table Oca_EPay_OldManAccount;
drop table Oca_EPay_Package;
drop table Oca_EPay_PackageItem;
drop table Oca_EPay_RechargeRecord;
drop table Oca_Ewallet_Charge_Record;
drop table Oca_Ewallet_Merchant;
drop table Oca_Ewallet_OldMan;
drop table Oca_Ewallet_Recharge_Record;
drop table Oca_FamilyCamera;
drop table Oca_FamilyMember;
drop table Oca_Merchant;
drop table Oca_MerchantServeItem;
drop table Oca_MerchantServeMode;
drop table Oca_MerchantServePeriod;
drop table Oca_MutualAidPerson;
drop table Oca_OldManBaseInfo;
drop table Oca_OldManConfigInfo;
drop table Oca_OldManDeviceInfo;
drop table Oca_OldManFamilyInfo;
drop table Oca_OldManHealthInfo;
drop table Oca_OldManLocateInfo;
drop table Oca_ServiceFamilyResponse;
drop table Oca_ServiceReceive;
drop table Oca_ServiceTrackLog;
drop table Oca_ServiceVoice;
drop table Oca_ServiceWorkOrder;
drop table Pub_Accounting_Period;
drop table Pub_Area;
drop table Pub_Attachment;
drop table Pub_Device;
drop table Pub_DeviceExtendInfo;
drop table Pub_EntityDefination;
drop table Pub_EntityDefinationHistory;
drop table Pub_Geography;
drop table Pub_Group;
drop table Pub_GroupMember;
drop table Pub_GroupPermit;
drop table Pub_MultiLanguageStorageBig;
drop table Pub_MultiLanguageStorageSmall;
drop table Pub_Reminder;
drop table Pub_ReminderObject;
drop table Pub_ServiceStation;
drop table Pub_SmsSend;
drop table Pub_User;
drop table Pub_UserArea;
drop table Pub_UserPermit;
drop table Pub_UserRePermit;
drop table ratio;
drop table sTV_00$01$01;
drop table sTV_00$01$02;
drop table sTV_00000;
drop table Sys_Application;
drop table Sys_ApplicationAccess;
drop table Sys_ApplicationAccessibility;
drop table Sys_ApplicationAccessPoint;
drop table Sys_Behavior;
drop table Sys_Dictionary;
drop table Cer_DeployNode;
drop table Sys_DictionaryItem;
drop table Cer_ObjectToken;

select name from sys.tables

select name from [smartlife-120300].sys.tables 
where name not in (select name from sys.tables ) and is_ms_shipped=0 
and name not in(select TableName from Cfg_Object where ObjectType='table' and ChangeType='not');