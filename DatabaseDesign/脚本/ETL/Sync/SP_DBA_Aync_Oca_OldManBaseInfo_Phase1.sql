...
/* */
/*******************************************************************************************/
create procedure [dbo].[SP_DBA_Aync_Oca_OldManBaseInfo_Phase1]
  ...
  set  @updateStr=''
   ...
   --------------更新
	  while @i<@count
			  begin
					  ...
					  set @srccol=@item
						...
						(select name,column_id,object_id from [SmartLife-120300].sys.all_columns
						 ...
						 and b.object_id=c.DescObjectId and c.phase=1
						 )					
		 ...
		 set @str='	update [SmartLife-120300].dbo.Oca_OldManBaseInfo set  '+@updateStr2+'
		 ...
		 print '--'+@str
 		 ...
 		 set @str='	update [SmartLife-120301].dbo.Oca_OldManBaseInfo set  '+@updateStr2+'
 	 ...
 	 set  @updateStr=''
 	  while @i<@count
		 ...
		 set @str='	update [SmartLife-120300].dbo.Eva_EvaluatedBaseInfo set  '+@updateStr2+'
