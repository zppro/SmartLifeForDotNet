...
/****** Object:  StoredProcedure [dbo].[SP_Dey_CreateFunctionMetaScript]    Script Date: 05/13/2014 17:20:45 ******/
SET ANSI_NULLS ON
GO
           ...
           begin
               ...
               select 3 VersionId,
                ...
                from   cfg_objectversionhistory a
                 where a.Type in ('F')  and BeforeLength<>AfterLength;	 
                end
