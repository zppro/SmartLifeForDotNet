$.ajaxf = new function () {
    ...
    this.request = function (url, data, callback, type, method, contentType) {
        var p = new Object();
        if (method)
            p['method'] = method;
        if (url)
    ...
    this.get = function (url, data, callback, type, contentType) {
        this.request(url, data, callback, type, 'get', contentType);
    }
    this.getText = function (url, data, callback) { this.get(url, data, callback, 'text'); }
    this.getJSON = function (url, data, callback) { this.get(url, data, callback, 'json', 'application/json; charset=utf-8'); }
    this.getScript = function (url, data, callback) { this.get(url, data, callback, 'script'); }
    this.post = function (url, data, callback, type, contentType) { this.request(url, data, callback, type, 'post', contentType); }
    this.postJSON = function (url, data, callback) { this.post(url, data, callback, 'json', 'application/json; charset=utf-8'); }
