...
{
    public partial class frmWorkOrderProcessed : Form
    {
        List<WorkOrderInfo> datas;
        bool isFetchingData = false;


        public frmWorkOrderProcessed()
        {
            InitializeComponent();
            ...
            if (!isFetchingData)
            {
                ...
                new Action(() =>
                {
                    ...
                    if (MerchantVar.CurrentMerchant.AuthNodeInfos.Count > 0)
                    {
                        ...
                        {
                            //string url = nodeInfo.AccessPoint.Replace("http://115.236.175.110:17000/merchantservices", "http://localhost/SmartLife.CertManage.MerchantServices") + "/Oca/WorkOrderService/GetWorkOrderProcessed";
                            string url = nodeInfo.AccessPoint + "/Oca/WorkOrderService/GetWorkOrderProcessed";
        ...
        private void frmWorkOrderProcessed_Load(object sender, EventArgs e)
        {
            InitSearchBox();
            InitGridView();
        }

        private void frmWorkOrderProcessed_Shown(object sender, EventArgs e)
        {
        ...
        {
            frmWorkOrderProcessedDetail frm = new frmWorkOrderProcessedDetail();
