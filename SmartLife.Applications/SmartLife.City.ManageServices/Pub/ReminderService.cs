...
{ 
    ...
    public class ReminderService : AppBaseWcfService
    {
        #region CMS标准接口
        ...
        public EasyUIgridCollectionInvokeResult<StringObjectDictionary> ListForEasyUIgrid(EasyUIgridCollectionParam<StringObjectDictionary> param)
        {
            ...
            try
            {
                ...
                gridCollectionPager.EasyUIgridDoPage<StringObjectDictionary>(BuilderFactory.DefaultBulder().ListStringObjectDictionary("Reminder_List2", filters), param, ref result);
            }
            catch (Exception ex)
            {
                result.Success = false;
