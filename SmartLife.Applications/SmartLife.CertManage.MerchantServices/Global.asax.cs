...
namespace SmartLife.CertManage.MerchantServices
{
    public class Global : HttpApplication
    {
        ...
        private void RegisterRoutes()
        {
            ...
            RouteTable.Routes.Add(new ServiceRoute("Oca/WorkOrderV2Service", new WebServiceHostFactory(), typeof(Oca.ServiceWorkOrderV2Service)));
            RouteTable.Routes.Add(new ServiceRoute("Oca/MerchantV2Service", new WebServiceHostFactory(), typeof(Oca.MerchantV2Service)));
        }
    }
}
