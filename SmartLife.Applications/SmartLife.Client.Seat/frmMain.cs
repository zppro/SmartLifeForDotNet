...
namespace SmartLife.Client.Seat
{
    ...
    public partial class frmMain : Form
    {
        ...
        #endregion
        #region 地址
        public const string CallDialBackListUrlAsEmergency = "/views/shared/tabContainer.htm?pageUrl=views/seat-client/call-for-dialback.htm&serviceType=0";
        public const string CallDialBackListUrlAsOther = "/views/shared/tabContainer.htm?pageUrl=views/seat-client/call-for-dialback.htm&serviceType=1|3";
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            wbPhoneList4DialBackAsEmergency.ObjectForScripting = this;
            wbPhoneList4DialBackAsOther.ObjectForScripting = this;
        ...
        public void SetEnvironment(string userId, string userCode, string userName, string extId, string extCode, string dialBackFlag, string callCenterId, string callCenterIP, string callCenterPort, string callCenterIPInner, string callCenterPortInner, string callCenterIPProxy, string callCenterPortProxy, string areaId)
        {
            ...
            _CheckIn(true, (result0, response0) =>
            {
                ...
                if (result0 == "+OK")
                {
                    ...
                    //加载回拨列表
                    wbPhoneList4DialBackAsEmergency.Url = new Uri(PlatformAddress + CallDialBackListUrlAsEmergency);
                    wbPhoneList4DialBackAsOther.Url = new Uri(PlatformAddress + CallDialBackListUrlAsOther);
                    _MessageLoopForCTI_Call();
                }
            });
            if (ServiceOnlineFlag)
            ...
            _CheckOut(false, (result1, response1) =>
            {
                if (result1 == "+OK")
                {
                    ...
                    BeginInvoke(new Action(() =>
                    {
                        ...
                        cbbServiceList.Visible = false;
                        wbPhoneList4DialBackAsEmergency.Url = new Uri("about:blank");
                        wbPhoneList4DialBackAsOther.Url = new Uri("about:blank");
                    }));
                }
            });
        ...
        public void DialBack(string callServiceId, string oldManId, string phoneNo, string oldManName, string serviceType)
        {
            ...
            WebBrowser wb = serviceType == "0" ? wbPhoneList4DialBackAsEmergency : wbPhoneList4DialBackAsOther;
            ...
            if (MessageBoxAdapter.ShowConfirm("确定要呼叫【" + phoneNo + "】？") == System.Windows.Forms.DialogResult.OK)
            {
                object oRet = wb.Document.InvokeScript("dialBackForCallService", new object[] { callServiceId, EnvironmentVar.ExtCode });
                if (oRet != null && oRet.ToString() != "{}")
                {
                    //开始回拨
        ...
        private void wbPhoneList4DialBack_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            wbPhoneList4DialBackAsEmergency.Document.InvokeScript("setExecModeForSeat");
            wbPhoneList4DialBackAsOther.Document.InvokeScript("setExecModeForSeat");
        }
        private void lbConferenceMember_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (index >= 0)
                {
                    ...
                    cmenuConference.Items.Find("cmenuitemKick", true)[0].Visible = (item.Value != EnvironmentVar.ExtCode && item.Value != _OldManPhoneNo);
                    ConferenceMemberItem memberItem = conferenceMembers[item.Value] as ConferenceMemberItem;
        ...
        private void cmenuitemKick_Click(object sender, EventArgs e)
        {
            ...
            _ControlConferenceMember("kick", item.Value);
        ...
        private void cmenuitemMute_Click(object sender, EventArgs e)
        {
            ...
            _ControlConferenceMember("mute", item.Value);
        }
        ...
        private void cmenuitemUnMute_Click(object sender, EventArgs e)
        {
            ...
            _ControlConferenceMember("unmute", item.Value);
        }
        ...
        private void cmenuitemDeaf_Click(object sender, EventArgs e)
        {
            ...
            _ControlConferenceMember("deaf", item.Value);
        }
        ...
        private void cmenuitemUnDeaf_Click(object sender, EventArgs e)
        {
            ...
            _ControlConferenceMember("undeaf", item.Value);
        }
        #endregion
