...
{ 
    ...
    public class OldManLocateInfoService : AppBaseWcfService
    {
        #region CMS标准接口
        ...
        #region 自定义
        [WebInvoke(UriTemplate = "FenceAlarmListByOldMan", Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
