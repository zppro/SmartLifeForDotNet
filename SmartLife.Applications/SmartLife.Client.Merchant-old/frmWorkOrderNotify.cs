...
namespace SmartLife.Client.Merchant
{
    public partial class frmWorkOrderNotify : Form
    {
        ...
        public frmWorkOrderNotify()
        {
            ...
            iconTimer = new System.Timers.Timer(400);
            iconTimer.Elapsed += new System.Timers.ElapsedEventHandler(delegate(object source, System.Timers.ElapsedEventArgs ee)
            {
                if (IconFlag)  //当该值为真时
                {
                    xIcon.Icon = Properties.Resources.leblue;//设定托盘控件taskBarIcon的图标
                    IconFlag = false;                       //修改该值为假
                }
                else                                            //当该值为假时
                {
                    xIcon.Icon = Properties.Resources.empty; //设定托盘控件taskBarIcon的图标
        ...
        public void ShowNewWindow()
        {
            ...
            xIcon.Icon = Properties.Resources.leblue;//设定托盘图标
        }
        #endregion
        ...
        public void ReceiveReminderStatInfo(WorkOrderReminderStatInfo reminderStatInfo)//自定义方法用来使托盘图标闪烁
        {
            ...
            if (_ReminderStatInfo != null && frmWorkOrderNotify.IconFlickerFlag != false)     //当托盘闪动图标为真时
            {
                ...
                BeginInvoke(new Action(() =>
                {
                    ...
                    lblMessage.Text = "您有" + _ReminderStatInfo.ReminderNum + "张" + typeItem.Text;
